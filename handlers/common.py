...
🎥 <b>Собрать Reels</b> — автоматический MP4 (классика / субтитры / музыка / Pro)
📦 <b>Content Pack</b> — заголовки, TL;DR, пост Telegram и хештеги одной кнопкой
...
• После сценария Reels — <b>Таймлайн</b> и варианты сборки:
  🎬 классика · 💬 субтитры · 🎵 музыка · ✨ Pro
• <b>📦 Content Pack</b> — пакет форматов для публикации
• <b>📁 Мои проекты</b> — сохранённые сценарии и таймлайны
• Для видео нужен <code>GEMINI_API_KEY</code> и FFmpeg на сервере
• B-roll: <code>PEXELS_API_KEY</code> · музыка: <code>PIXABAY_API_KEY</code>
